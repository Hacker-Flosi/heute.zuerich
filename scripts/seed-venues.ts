...
const ZUERICH_VENUES: VenueSeed[] = [
  ...
  { name: 'Volkshaus', eventfrogName: 'Volkshaus Zürich', city: 'zuerich', tier: 'S', category: 'alternative', active: true, summerBonus: false, website: 'https://volkshaus-zuerich.ch' },
  { name: 'Maag Halle', eventfrogName: 'Maag Halle Zürich', city: 'zuerich', tier: 'S', category: 'kultur', active: true, summerBonus: false, website: 'https://www.maag.ch' },
  ...
  { name: 'Mädchere', eventfrogName: 'Mädchere Zürich', city: 'zuerich', tier: 'A', category: 'electronic', active: true, summerBonus: false },
  { name: 'Klaus', eventfrogName: 'Klaus Zürich', city: 'zuerich', tier: 'A', category: 'electronic', active: true, summerBonus: false },
  ...
  { name: 'Sender', eventfrogName: 'Sender Zürich', city: 'zuerich', tier: 'A', category: 'alternative', active: true, summerBonus: false, website: 'https://sender.club' },
  // Tier B — Mainstream
  { name: 'Plaza', eventfrogName: 'Plaza Club Zürich', city: 'zuerich', tier: 'B', category: 'mainstream', active: true, summerBonus: false },
  { name: 'Vior', eventfrogName: 'Vior Zürich', city: 'zuerich', tier: 'B', category: 'mainstream', active: true, summerBonus: false },
  { name: 'Jade', eventfrogName: 'Jade Club Zürich', city: 'zuerich', tier: 'B', category: 'mainstream', active: true, summerBonus: false },
  { name: 'Aura', eventfrogName: 'Aura Zürich', city: 'zuerich', tier: 'B', category: 'mainstream', active: true, summerBonus: false },
  { name: 'Icon', eventfrogName: 'Icon Club Zürich', city: 'zuerich', tier: 'B', category: 'mainstream', active: true, summerBonus: false },
  { name: 'Alice Choo', eventfrogName: 'Alice Choo Zürich', city: 'zuerich', tier: 'B', category: 'mainstream', active: true, summerBonus: false },
  // Tier B — Bars
  { name: 'Gonze', eventfrogName: 'Gonze Zürich', city: 'zuerich', tier: 'B', category: 'bar', active: true, summerBonus: false },
  { name: 'Olé Olé Bar', eventfrogName: 'Olé Olé Bar Zürich', city: 'zuerich', tier: 'B', category: 'bar', active: true, summerBonus: false },
  { name: 'Kasheme', eventfrogName: 'Kasheme Zürich', city: 'zuerich', tier: 'B', category: 'bar', active: true, summerBonus: false },
  ...
  { name: 'Rimini Bar', eventfrogName: 'Rimini Bar Zürich', city: 'zuerich', tier: 'B', category: 'bar', active: true, summerBonus: true },
  { name: 'Barfussbar', eventfrogName: 'Barfussbar Zürich', city: 'zuerich', tier: 'B', category: 'bar', active: true, summerBonus: true },
  { name: 'Samigo Amusement', eventfrogName: 'Samigo Amusement Zürich', city: 'zuerich', tier: 'B', category: 'bar', active: true, summerBonus: false },
  // Tier B — Kultur
  { name: 'Schiffbau', eventfrogName: 'Schiffbau Zürich', city: 'zuerich', tier: 'B', category: 'kultur', active: true, summerBonus: false },
  { name: 'Labor Bar', eventfrogName: 'Labor Bar Zürich', city: 'zuerich', tier: 'B', category: 'bar', active: true, summerBonus: false },
  ...
  { name: 'Folium', eventfrogName: 'Folium Zürich', city: 'zuerich', tier: 'B', category: 'kultur', active: true, summerBonus: false },
  { name: 'Millers', eventfrogName: 'Millers Zürich', city: 'zuerich', tier: 'B', category: 'kultur', active: true, summerBonus: false },
  ...
  // Tier C
  { name: 'Heile Welt', eventfrogName: 'Heile Welt Zürich', city: 'zuerich', tier: 'C', category: 'bar', active: true, summerBonus: false },
  { name: 'Bagatelle', eventfrogName: 'Bagatelle Zürich', city: 'zuerich', tier: 'C', category: 'bar', active: true, summerBonus: false },
  { name: 'Sektor 11', eventfrogName: 'Sektor 11 Zürich', city: 'zuerich', tier: 'C', category: 'electronic', active: true, summerBonus: false },
  { name: 'Hard One', eventfrogName: 'Hard One Zürich', city: 'zuerich', tier: 'C', category: 'electronic', active: true, summerBonus: false },
...
const BASEL_VENUES: VenueSeed[] = [
  ...
  { name: 'Viertel Klub', eventfrogName: 'Viertel Klub Basel', city: 'basel', tier: 'A', category: 'electronic', active: true, summerBonus: false },
  { name: 'Elysia', eventfrogName: 'Elysia Basel', city: 'basel', tier: 'A', category: 'electronic', active: true, summerBonus: false },
  { name: 'Balz Klub', eventfrogName: 'Balz Klub Basel', city: 'basel', tier: 'A', category: 'electronic', active: true, summerBonus: false },
  { name: 'Heimat Club', eventfrogName: 'Heimat Club Basel', city: 'basel', tier: 'A', category: 'electronic', active: true, summerBonus: false },
  { name: 'Singer Klub', eventfrogName: 'Singer Klub Basel', city: 'basel', tier: 'A', category: 'mainstream', active: true, summerBonus: false },
  ...
  { name: 'Club 59', eventfrogName: 'Club 59 Basel', city: 'basel', tier: 'B', category: 'mainstream', active: true, summerBonus: false },
  { name: 'Renée', eventfrogName: 'Renée Basel', city: 'basel', tier: 'B', category: 'bar', active: true, summerBonus: false },
  { name: 'Basso', eventfrogName: 'Basso Basel', city: 'basel', tier: 'B', category: 'bar', active: true, summerBonus: false },
  ...
  { name: 'Sandoase', eventfrogName: 'Sandoase Basel', city: 'basel', tier: 'B', category: 'bar', active: true, summerBonus: true },
  // Tier B — Kultur
...
const BERN_VENUES: VenueSeed[] = [
  ...
  { name: 'Kapitel Bollwerk', eventfrogName: 'Kapitel Bollwerk Bern', city: 'bern', tier: 'A', category: 'electronic', active: true, summerBonus: false },
  ...
  { name: 'Stellwerk', eventfrogName: 'Stellwerk Bern', city: 'bern', tier: 'A', category: 'electronic', active: true, summerBonus: false },
  // Tier A — Alternative/Kultur
  ...
  { name: 'Turnhalle', eventfrogName: 'Turnhalle Bern', city: 'bern', tier: 'A', category: 'alternative', active: true, summerBonus: false },
  { name: 'Café Kairo', eventfrogName: 'Café Kairo Bern', city: 'bern', tier: 'A', category: 'bar', active: true, summerBonus: false },
  // Tier B — Mainstream/Bars
  { name: 'Maison', eventfrogName: 'Maison Bern', city: 'bern', tier: 'B', category: 'mainstream', active: true, summerBonus: false },
  { name: 'Huma Club', eventfrogName: 'Huma Club Bern', city: 'bern', tier: 'B', category: 'mainstream', active: true, summerBonus: false },
  { name: "L'Ovestino", eventfrogName: "L'Ovestino Bern", city: 'bern', tier: 'B', category: 'bar', active: true, summerBonus: false },
  { name: 'Cuba Bar', eventfrogName: 'Cuba Bar Bern', city: 'bern', tier: 'B', category: 'bar', active: true, summerBonus: false },
  { name: 'Sous le Pont', eventfrogName: 'Sous le Pont Bern', city: 'bern', tier: 'B', category: 'bar', active: true, summerBonus: false },
  // Tier B — Kultur
  ...
  { name: 'Grosse Halle', eventfrogName: 'Grosse Halle Bern', city: 'bern', tier: 'B', category: 'kultur', active: true, summerBonus: false },
  ...
  { name: 'Attika Bar', eventfrogName: 'Attika Bar Bern', city: 'bern', tier: 'B', category: 'bar', active: true, summerBonus: true },
]
...
const STGALLEN_VENUES: VenueSeed[] = [
  ...
  { name: 'Schwarzmatt Events', eventfrogName: 'Schwarzmatt St. Gallen', city: 'stgallen', tier: 'A', category: 'special', active: true, summerBonus: true },
  // Tier A — Kultur
  ...
  // Tier B
  { name: 'Gallus Pub', eventfrogName: 'Gallus Pub St. Gallen', city: 'stgallen', tier: 'B', category: 'bar', active: true, summerBonus: false },
  { name: 'Trischli Club', eventfrogName: 'Trischli Club St. Gallen', city: 'stgallen', tier: 'B', category: 'electronic', active: true, summerBonus: false },
  ...
  { name: 'Point Jaune Museum', eventfrogName: 'Point Jaune Museum St. Gallen', city: 'stgallen', tier: 'B', category: 'kultur', active: true, summerBonus: false },
  { name: 'Militärkantine', eventfrogName: 'Militärkantine St. Gallen', city: 'stgallen', tier: 'B', category: 'alternative', active: true, summerBonus: false },
]
...
const LUZERN_VENUES: VenueSeed[] = [
  ...
  { name: 'Rok', eventfrogName: 'Rok Luzern', city: 'luzern', tier: 'A', category: 'electronic', active: true, summerBonus: false },
  // Tier A — Kultur
  ...
  { name: 'Volière', eventfrogName: 'Volière Luzern', city: 'luzern', tier: 'B', category: 'bar', active: true, summerBonus: false },
  { name: 'Bar 59', eventfrogName: 'Bar 59 Luzern', city: 'luzern', tier: 'B', category: 'bar', active: true, summerBonus: false },
  { name: 'Casineum', eventfrogName: 'Casineum Luzern', city: 'luzern', tier: 'B', category: 'special', active: true, summerBonus: false },
  { name: 'Alpineum', eventfrogName: 'Alpineum Luzern', city: 'luzern', tier: 'B', category: 'alternative', active: true, summerBonus: false },
