...
const ZUERICH_VENUES: VenueSeed[] = [
  ...
  { name: 'Komplex 457', eventfrogName: 'Komplex 457', city: 'zuerich', tier: 'S', category: 'electronic', active: true, summerBonus: false, website: 'https://komplex-457.ch' },
  ...
  // Tier A — Electronic
  { name: 'Hive', eventfrogName: 'Hive Club Zürich', city: 'zuerich', tier: 'A', category: 'electronic', active: true, summerBonus: false, website: 'https://www.hiveclub.ch' },
  ...
  { name: 'Zukunft', eventfrogName: 'Zukunft Zürich', city: 'zuerich', tier: 'A', category: 'electronic', active: false, summerBonus: false, website: 'https://zukunft.cc' },
