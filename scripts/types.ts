...
export interface RawEvent {
  ...
  time: string       // HH:MM
  url: string
  source: 'eventfrog' | 'hellozurich' | 'saiten' | 'gangus' | 'coucou' | 'kulturzueri' | 'stadt-zuerich' | 'guidle' | 'residentadvisor' | 'petzi' | 'dampfzentrale' | 'stgallen-venues' | 'basel-venues' | 'manual'
  eventType?: EventType
  layer?: PipelineLayer
